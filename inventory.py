...
class Inv():
    ...
    def spawn_item(self, self.capacity, item_ID):
    ...
    def add_item(self, item_ID):
        ...
        self.items.append(item_ID)
    def list_items(self.items, self.space):
        print("\n")
        ...
        for i in range(len(self.items)):
            ...
            print("{}- {}".format((i+1), item_ID.get_the_basics)
        print("\n")
...
class Item(self, item_ID, item_DICT, item_value):
    ...
    def get_the_basics(self):
        return "{} ({}, {})".format(self.name,self.dictnry['spec'],self.dictnry['rarity'].if(item_DICT['rarity'] != 0))
